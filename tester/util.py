...
def find_discrepancies(certificate_dir, test_scripts, ca_file\
        ,starting_port = 10000, ending_port = 20000, pool_size = 4, ignore_none = False):
    base_results = tester.test_dir(certificate_dir, test_scripts, ca_file, starting_port, ending_port, pool_size)
    if ignore_none:
        new_res = dict()
