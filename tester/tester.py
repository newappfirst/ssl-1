...
def _run_single_test(tupl):
    ...
    return output.strip()
def run_test(certificate_file, test_scripts, ca_file, key_file, starting_port = 10000, pool_size=4):
    results = []
...
def test_dir(certificate_dir, test_scripts, ca_file, key_file, starting_port = 10000, ending_port = 20000, pool_size = 4):
    ...
    for cert in os.listdir(certificate_dir):
        ...
        results[cert] = run_test(cert_path, test_scripts, ca_file, key_file, starting_port, pool_size)
